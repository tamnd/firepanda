...
QUERIES = (1, 3, 4, 5, 6, 10, 12, 15, 16, 18, 19)
...
a name resolved across a self join, and each one goes in here the day it runs
rather than being listed as a pending failure.
"""
