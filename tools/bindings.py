...
def _string_members() -> tuple[Member, ...]:
    ...
    return (
        ...
        Member(
            ...
            kind="method",
            signature="",
            body='self._flag("isalpha", "")',
            doc="Whether every row is letters and nothing else.",
            returns="Series",
        ),
        Member(
            name="isnumeric",
            kind="method",
            signature="",
            body='self._flag("isnumeric", "")',
            doc="Whether every row is numbers and nothing else.",
            returns="Series",
        ),
        Member(
            name="isdigit",
            kind="method",
            signature="",
            body='self._flag("isdigit", "")',
            doc="Whether every row is digits and nothing else.",
            returns="Series",
        ),
        Member(
            name="isdecimal",
            kind="method",
            signature="",
            body='self._flag("isdecimal", "")',
            doc="Whether every row is decimal digits and nothing else.",
            returns="Series",
        ),
        Member(
            name="isalnum",
            kind="method",
            signature="",
            body='self._flag("isalnum", "")',
            doc="Whether every row is letters and numbers and nothing else.",
            returns="Series",
        ),
        Member(
            name="removeprefix",
    ...
    members=(
        ...
        *_correlations("DataFrame"),
        ...
        Member(
            ...
            kind="method",
            signature="other: Any",
            body="self._combine_first(other)",
            doc="Every missing value filled from the same place in another frame.",
            returns="DataFrame",
        ),
...
SERIES = Exposed(
    ...
    members=(
        ...
        Member(
            name="between",
            kind="method",
            signature='left: Any, right: Any, inclusive: str = "both"',
            body="self._between(left, right, inclusive)",
            doc="Whether each value lies between two bounds, with a missing value False.",
            returns="Any",
        ),
        Member(
            name="value_counts",
        ...
        *_correlations("Series"),
        ...
        Member(
            ...
            signature="other: Any",
            body="self._combine_first(other)",
            doc="Every missing value filled from the same label in another column.",
            returns="Series",
        ),
        Member(
            name="searchsorted",
