...
def test_a_pattern_python_answers_and_re2_refuses_is_still_a_gap() raises:
    ...
    lookbehind is a pattern pandas answers and this engine does not, and saying
    so is the whole of what the flag is for.

    The lookahead was this row's example until document 93 answered it, which is
    the first time one of the five constructs moved out of this list."""
