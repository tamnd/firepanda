...
def register(mut module: PythonModuleBuilder) raises:
    ...
    _ = dataframe.def_method[PyDataFrame.group_broadcast](
        "group_broadcast",
    ...
    _ = series.def_method[PySeries.string_partition](
        "string_partition",
        docstring="Every row cut at a separator, as three columns.",
    )
