"""The one to one fold a case insensitive search compares through.
...
1457 code points fold to something other than themselves under that rule and
...
Generated by tools/gen_searchfold.py against pyarrow 25.0.1 and Python
3.13.12, and verified against both rather than against the rule it was derived
...
comptime SEARCHED_FROM: InlineArray[UInt32, 1457] = [
    0x0041,
    0x0042,
    0x0043,
    0x0044,
...
comptime SEARCHED_TO: InlineArray[UInt32, 1457] = [
    0x0061,
    0x0062,
    0x0063,
    0x0064,
