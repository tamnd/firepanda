...
class DataFrame:
    ...
    def join_on(
        ...
        ...
    def stack_rows(self, others: list[DataFrame], names: list[str], labels: bool) -> DataFrame:
        """This frame and others stacked down the rows."""
        ...
    def stack_columns(self, others: list[DataFrame]) -> DataFrame:
        """This frame and others side by side."""
        ...
